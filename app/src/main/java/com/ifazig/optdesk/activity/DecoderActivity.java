...
import com.ifazig.optdesk.utils.PointsOverlayView;
...
public class DecoderActivity extends AppCompatActivity
    ...
    public void onQRCodeRead(String text, PointF[] points) {
        ...
        if (text != null && !text.isEmpty()) {
            ...
            intent.putExtra("QRKEY", text);
            setResult(RESULT_OK, intent);
            finish();
        }else {
            CommonFunctions.getInstance().validationInfoError(DecoderActivity.this, LanguageConstants.qrcodenotempty);
            finish();
        }
