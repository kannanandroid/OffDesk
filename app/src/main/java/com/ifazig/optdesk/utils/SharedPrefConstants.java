...
public class SharedPrefConstants {
    public static final String APP_PREFERENCE_NAME = "_pref_client_help_desk_one";
    ...
    public static final String GROUPID = "_pref_group_id";
    public static final String COMPANYDETAILS = "_pref_company_list_id";
    public static final String USERID = "_pref_user_id";
    public static final String ROLEID = "_pref_role_id";
