...
import com.ifazig.optdesk.activity.MainActivity;
...
public class GeofenceRegistrationService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (geofencingEvent.hasError()) {
            ...
            if (transaction == Geofence.GEOFENCE_TRANSITION_ENTER && geofence.getRequestId().equals(ConstantsNew.GEOFENCE_ID)) {
