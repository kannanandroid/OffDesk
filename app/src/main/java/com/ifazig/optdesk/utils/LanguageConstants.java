...
public class LanguageConstants {
    ...
    public static String optDesk = "Opt Desk";
    ...
    public static String registeraccount = "Register Account";
    public static String doyouhacaccount = "Do you have account?";
    public static String rememberme = "Remember me";
    public static String registera = "Register a";
    ...
    public static String resendotp = "Resend Otp";
    ...
    public static String helpsupport = "Help";
    public static String home = "Home";
    public static String qrcodenotempty = "QR Code is not Valid";
    public static String search = "Search";
    public static String continuetxt = "Continue";
    public static String passtbookins = "Past Booking";
    public static String upcoming = "Upcoming";
    public static String noDataFound = "No Data Found";
    public static String bookingtype = "Booking Type";
    public static String currentDay = "Current Day";
    public static String bulkBooking = "Bulk Booking";
    public static String bookyourworkstation = "Book your WorkStation";
    public static String selectDateFirst = "Select date first";
    public static String selectTimeSlot = "Select Time Slot";
    public static String selectTime = "Select Time";
